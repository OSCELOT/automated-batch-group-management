...
/**
 * An interface to the Blacboard course persisters for managing groups and memberships.
 * <p/>
...
public class BbGroupManager {
   ...
   * @throws PersistenceException Description of the Exception
  ...
  /**
   * Find or create a Group objects based on snapshot group keys. If a Group matching the GroupRecord does not already exist, one will be created with
   ...
   * @throws PersistenceException Thrown by Bb persistence mechanism
   * @throws ValidationException Thrown if the key is not valid for the title of the group
   */
   ...
   * @throws PersistenceException Thrown by underlying Bb
   * @throws ValidationException Thrown by underlying Bb
   */
  ...
  /**
   * Remove a group. This will succeed even if the Group or all of the students currently in the group were not added by BbGroupManager.
   *
   ...
   * @throws PersistenceException Thrown by Bb
   */
  ...
  /**
   * Remove a student from a group. If the student was not added by the BbGroupManager, this operation will fail with a KeyNotFoundException.
   *
   * @param group The Group to remove the student from
   * @param studentId The string id of the student.
   * @throws PersistenceException Description of the Exception
   * @throws KeyNotFoundException Thrown if the studentId does not exist in the system
   */
