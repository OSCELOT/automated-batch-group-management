...
/**
 * Parses a group definition file. We assume that the file will have the following fields:
 * <p/>
 * <ul>
 *   <li>course_id</li>
 *   <li>group_id</li>
...
public class GroupParser {
   ...
   * @return A GroupRecord whose courseId and external groupId match the provided values, or <code>null</code> if one does not exist.
   */
   ...
   * @throws IOException Thrown if file is not found or there is an error reading
   * @throws ParseException Thrown if the file is in an unparsable format
   */
