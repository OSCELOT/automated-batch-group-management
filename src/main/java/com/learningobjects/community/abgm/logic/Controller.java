...
/**
 * This is the main entry-point for the logic in the project.
 * <p/>
...
public class Controller {
   ...
   *
   * @throws ControllerException Description of the Exception
   */
  ...
  /**
   * Update the groups data to reflect a new snapshot. The Controller will:
   * <p/>
   * <ol>
   ...
   * @throws ControllerException Thrown if the Controller is unable to execute the task.
   */
  ...
  /**
   * Given group and membership definition files, do an initial load all definitions into the Bb backing store. Assumes that Context is established.
   *
   * @param groups A File containing group definitions
   * @param memberships A File containing membership definitions
   * @throws ControllerException Thrown if the Controller is unable to execute the task.
   ...
   * @param groups A File containing group definitions
   * @param memberships A File containing membership definitions
   * @throws IOException Thrown if there is a IO problem creating the backups
   */
   ...
   * @throws IOException Thrown if data cannot be read or written.
   */
