...
public class ConfigServlet extends HttpServlet {
  ...
  private void sendReceipt(HttpServletRequest request, HttpServletResponse response, String message, boolean success, Exception e) throws ServletException, IOException {
  ...
  private void doUpdate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
      ...
      sp.setProperty("groupMembershipFileLocation", StringUtils.trimToEmpty(request.getParameter("groupMembershipFileLocation")));
      ...
      if (sp.getProperty("schedule","").length()>0) {
        ...
        CronTrigger trigger = new CronTrigger("myTrigger", scheduler.DEFAULT_GROUP, SystemProperties.getInstance().getProperty("schedule"));
      ...
      sendReceipt(request, response, (updateMessage.length() == 0) ? "The changes have been applied successfully." : updateMessage , true, null);
