...
/**
 *  An interface to the Blacboard course persisters for managing groups and
 *  memberships. <br/>
...
public class BbGroupManager {
    ...
    /**
     *  Map GroupRecord keys from data file to Id objects to account for changing
     *  titles of Groups.
     */
     ...
     *
     * @param  store                     The file that BbGroupManager should
     *      save/load its cached information to/from.
    ...
    /**
     *  Find or create a Group objects based on snapshot group keys. If a Group
     *  matching the GroupRecord does not already exist, one will be created with
     *  the properties as specified in the GroupRecord object.
     *
     * @param  groupRecord               A GroupRecord that represents the Group
     *      that we are interested in.
     * @return                           A reference to the group
     * @exception  PersistenceException  Thrown by Bb persistence mechanism
     * @exception  ValidationException   Thrown if the key is not valid for the
     *      title of the group
     */
     ...
     * @param  groupRecord               A GroupRecord that represents the Group
     *      that we are interested in.
     * @param  create                    Indicate if the group should be created if
     *      it does not exist
     * @return                           A reference to the group
     * @exception  PersistenceException  Thrown by Bb persistence mechanism
     * @exception  ValidationException   Thrown if the key is not valid for the
     *      title of the group
     */
    public Group getGroup(final GroupRecord groupRecord, final boolean create) throws PersistenceException, ValidationException {
        Id groupId;
        Group toReturn;
        ...
        if (groupId == null) {//Not managed by us, must create
            ...
            } catch (KeyNotFoundException e) {//This shouldn't happen, but let's try to continue
                synchronized (groupMap) {
     ...
     *
     * @param  groupRecord               A GroupRecord with the identification of
     *      and new properties that the group should have.
    ...
    /**
     *  Remove a group. This will succeed even if the Group or all of the students
     *  currently in the group were not added by BbGroupManager.
     *
     ...
     * @return                           <code>true</code> iff the student is a
     *      member of <code>group</code>
    ...
    /**
     *  Adds a student to a Group. The BbGroupManager will "remember" that it added
     *  the student to the Group.
     *
    ...
    /**
     *  Remove a student from a group. If the student was not added by the
     *  BbGroupManager, this operation will fail with a KeyNotFoundException.
     *
